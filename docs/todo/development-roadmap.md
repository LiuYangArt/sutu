...
> 版本: 0.2.0 | 更新日期: 2026-01-16 | 创建日期: 2026-01-11
...
## M1: 基础绘画 (Foundation) ✅ 基本完成

**目标**: 在画布上实现基本的压感绘画功能

> [!NOTE]
> 核心绘画功能已完成，仅剩放大镜工具 (1.6) 待实现
...
4. **M1.6: 放大镜工具** - 优先完成 MVP 遗留项
5. **M3.3-3.5: 高级笔刷** - ABR 导入、笔刷预设
6. **M5.1-5.3: 文件保存** - 项目保存/加载
7. **M7.2: Docking 系统** - 专业级面板布局
